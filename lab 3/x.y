...
%token ID LPAREN RPAREN COMMA LCURL RCURL SEMICOLON INT FLOAT VOID LTHIRD RTHIRD CONST_INT FOR IF ELSE  WHILE PRINTLN RETURN ASSIGNOP LOGICOP RELOP ADDOP MULOP NOT CONST_FLOAT INCOP DECOP DO BREAK CONTINUE CHAR DOUBLE SWITCH CASE DEFAULT
%nonassoc LELSE
%%
...
func_definition : type_specifier ID LPAREN parameter_list RPAREN compound_statement
		{
			outlog<<"At line no: "<<lines<<" func_definition : type_specifier ID LPAREN  compound_statement "<<endl<<endl;
...
compound_statement : LCURL statements RCURL
	    ...
	    | LCURL RCURL
		{
			...
			$$ = new symbol_info($1->getname()+$2->getname(),"comp_statement");	
...
declaration_list : declaration_list COMMA ID
       ...
       | declaration_list COMMA ID LTHIRD CONST_INT RTHIRD
	   {
		    ...
		    outlog<<$1->getname()<<","<<$3->getname()<<$4->getname()<<$5->getname()<<$6->getname()<<endl<<endl;
			
		    $$ = new symbol_info($1->getname()+","+$3->getname()+$4->getname()+$5->getname()+$6->getname(),"dec_list");
	   }
       | ID
	   {
       ...
       | ID LTHIRD CONST_INT RTHIRD
	   {
		    ...
		    $$ = new symbol_info($1->getname()+$2->getname()+$3->getname()+$4->getname(),"dec_list");	
	   }
	   ;
...
| IF LPAREN expression RPAREN statement %prec LELSE
    {
...
| PRINTLN LPAREN ID RPAREN SEMICOLON
    {
			...
			$$ = new symbol_info($1->getname()+"("+$3->getname()+");","stmnt");
...
| RETURN expression SEMICOLON
    {  
			...
			$$ = new symbol_info($1->getname()+$2->getname()+";","stmnt");
...
| variable ASSIGNOP logic_expression
    {
		    outlog<<"At line no: "<<lines<<"variable : variable ASSIGNOP logic_expression "<<endl<<endl;
